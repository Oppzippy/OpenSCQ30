// Taken from libcosmic and modified to fix text color bug
...
use cosmic::{
    ...
    iced::{
        self, Alignment, Background, Color, Length,
        core::{Border, Shadow},
    },
    theme,
    widget::{self, icon},
...
impl<'a, Message: 'static + Clone> Warning<'a, Message> {
    ...
    pub fn into_widget(self) -> widget::Container<'a, Message, cosmic::Theme, Renderer> {
        let label = widget::container(cosmic::widget::text(self.message))
