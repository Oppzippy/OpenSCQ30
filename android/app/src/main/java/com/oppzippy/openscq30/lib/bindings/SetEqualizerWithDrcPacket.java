...
public final class SetEqualizerWithDrcPacket {
    @Override
    public boolean equals(Object obj) {
        if (obj instanceof SetEqualizerWithDrcPacket)
            return ((SetEqualizerWithDrcPacket)obj).rustEq(this);
        return false;
    }


    private final boolean rustEq(@NonNull SetEqualizerWithDrcPacket other) {
    ...
    public SetEqualizerWithDrcPacket(@NonNull EqualizerConfiguration left_configuration, @Nullable EqualizerConfiguration right_configuration) {
    ...
    /*package*/ SetEqualizerWithDrcPacket(InternalPointerMarker marker, long ptr) {
