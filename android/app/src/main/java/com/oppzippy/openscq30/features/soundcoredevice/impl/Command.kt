...
sealed class Command {
    ...
    class Write(val bytes: ByteArray) : Command() {
        override fun toString(): String = "Command.Write $bytes"
    }

    class WriteDescriptor(val descriptor: BluetoothGattDescriptor, val value: ByteArray) : Command() {
        override fun toString(): String = "Command.SetDescriptor ${descriptor.uuid} $value"
    }

    class SetMtu(val mtu: Int) : Command() {
        override fun toString(): String = "Command.SetMtu $mtu"
    }
}
