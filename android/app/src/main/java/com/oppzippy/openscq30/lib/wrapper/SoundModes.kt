...
data class SoundModes(
    ...
    fun toProtobuf(): com.oppzippy.openscq30.lib.protobuf.SoundModes = soundModes {
...
fun com.oppzippy.openscq30.lib.protobuf.SoundModes.toKotlin(): SoundModes = SoundModes(
...
enum class AmbientSoundMode {
    ...
    fun toProtobuf(): com.oppzippy.openscq30.lib.protobuf.AmbientSoundMode = when (this) {
...
fun com.oppzippy.openscq30.lib.protobuf.AmbientSoundMode.toKotlin(): AmbientSoundMode = when (this) {
...
data class AmbientSoundModeCycle(
    ...
    fun toProtobuf(): com.oppzippy.openscq30.lib.protobuf.AmbientSoundModeCycle = ambientSoundModeCycle {
...
fun com.oppzippy.openscq30.lib.protobuf.AmbientSoundModeCycle.toKotlin(): AmbientSoundModeCycle = AmbientSoundModeCycle(
...
enum class NoiseCancelingMode {
    ...
    fun toProtobuf(): com.oppzippy.openscq30.lib.protobuf.NoiseCancelingMode = when (this) {
...
fun com.oppzippy.openscq30.lib.protobuf.NoiseCancelingMode.toKotlin(): NoiseCancelingMode = when (this) {
...
enum class TransparencyMode {
    ...
    fun toProtobuf(): com.oppzippy.openscq30.lib.protobuf.TransparencyMode = when (this) {
...
fun com.oppzippy.openscq30.lib.protobuf.TransparencyMode.toKotlin(): TransparencyMode = when (this) {
