...
sealed class Battery {
    ...
    fun toProtobuf(): com.oppzippy.openscq30.lib.protobuf.Battery = when (this) {
...
fun com.oppzippy.openscq30.lib.protobuf.Battery.toKotlin(): Battery = when (this.batteryCase) {
...
data class DualBattery(val left: SingleBattery, val right: SingleBattery) {
    fun toProtobuf(): com.oppzippy.openscq30.lib.protobuf.DualBattery = dualBattery {
...
fun com.oppzippy.openscq30.lib.protobuf.DualBattery.toKotlin(): DualBattery =
    DualBattery(left = left.toKotlin(), right = right.toKotlin())

data class SingleBattery(val isCharging: Boolean, val level: UByte) {
    fun toProtobuf(): com.oppzippy.openscq30.lib.protobuf.SingleBattery = singleBattery {
...
fun com.oppzippy.openscq30.lib.protobuf.SingleBattery.toKotlin(): SingleBattery =
    SingleBattery(isCharging = isCharging, level = level.toUByte())
