...
7. In the bug report zip file, the log is located at one of these, depending on your Android version: `FS/data/misc/bluetooth/logs/btsnoop_hci.log`, `FS\data\log\bt\btsnoop_hci.log`
