...
auto-power-off-prompt = Aviso de Desligar Automático
listening-mode-prompt = Aviso de Modo de Escuta
incoming-calls-during-bluetooth-mode = Receber Chamadas durante Modo Bluetooth
noise-canceling-prompt = Indicação de Cancelamento de Ruído
auto-stop-timer = Temporizador de Parada Automática
auto-stop-timer-duration = Duração do Temporizador de Parada Automática
alarms = Alarmes
listening-mode = Modo de Escuta
default-listening-mode = Modo de Escuta Prédefinido
