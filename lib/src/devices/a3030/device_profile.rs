...
use super::packets::A3030StateUpdatePacket;

pub(crate) const A3030_DEVICE_PROFILE: DeviceProfile = DeviceProfile {
    ...
    compatible_models: &[DeviceModel::A3030],
    implementation: || StandardImplementation::new::<A3030StateUpdatePacket>(),
};
