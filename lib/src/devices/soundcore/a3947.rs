...
soundcore_device!(
    A3947State,
    async |packet_io| {
        fetch_state_from_state_update_packet::<A3947State, A3947StateUpdatePacket>(packet_io).await
    },
    async |builder| {
        ...
        device
            .assert_set_settings_response(
                ...
                vec![packet::Outbound::new(
                    ...
                    // TODO one of the DRC bytes is off by 1. We calculate 121 but it should be 120.
                    vec![
                        254, 254, 0, 0, 120, 121, 122, 123, 124, 125, 126, 127, 120, 120, 120, 121,
                        122, 123, 124, 125, 126, 127, 120, 120, 0, 0, 0, 112, 117, 140, 148, 150,
                        ...
                        121, 120, 0, 120, 120, 120, 120, 120, 120, 120, 121, 120, 0, 0,
                    ],
                )],
            )
            .await;
