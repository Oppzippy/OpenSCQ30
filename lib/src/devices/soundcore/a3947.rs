        ...
        device
            .assert_set_settings_response(
                ...
                vec![packet::Outbound::new(
                    ...
                    vec![
                        254, 254, 0, 0, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120,
                        120, 120, 120, 120, 120, 120, 120, 120, 0, 0, 0, 112, 117, 140, 148, 150,
                        ...
                        120, 120, 0, 120, 120, 120, 120, 120, 120, 120, 120, 120, 0, 0,
                    ],
                )],
            )
            .await;
