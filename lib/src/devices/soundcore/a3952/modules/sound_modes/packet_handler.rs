...
impl SoundModesPacketHandler {
    pub const COMMAND: Command = a3952::packets::inbound::SoundModesUpdatePacket::COMMAND;
}

#[async_trait]
impl<T> PacketHandler<T> for SoundModesPacketHandler
where
    T: Has<a3952::structures::SoundModes> + Send + Sync,
{
    async fn handle_packet(
        ...
        let packet: a3952::packets::inbound::SoundModesUpdatePacket = packet.try_to_packet()?;
