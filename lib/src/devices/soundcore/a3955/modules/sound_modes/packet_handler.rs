...
impl SoundModesPacketHandler {
    pub const COMMAND: packet::Command = a3955::packets::inbound::A3955SoundModes::COMMAND;
}

#[async_trait]
impl<T> PacketHandler<T> for SoundModesPacketHandler
where
    T: Has<a3955::structures::SoundModes> + Send + Sync,
{
    async fn handle_packet(
        ...
        let packet: a3955::packets::inbound::A3955SoundModes = packet.try_to_packet()?;
