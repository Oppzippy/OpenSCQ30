...
where
    T: Has<a3955::structures::SoundModes> + Clone + Send + Sync,
    ConnectionType: RfcommConnection + Send + Sync,
{
    async fn move_to_state(
        ...
        for step in change_plan {
            self.packet_io
                .send_with_response(
                    &a3955::packets::outbound::A3955SetSoundModes { sound_modes: step }.to_packet(),
                )
                .await?;
...
fn create_change_plan(
    from: a3955::structures::SoundModes,
    to: a3955::structures::SoundModes,
) -> Vec<a3955::structures::SoundModes> {
...
fn set_ambient_sound_mode(
    current: &mut a3955::structures::SoundModes,
    to: &a3955::structures::SoundModes,
    sequence: &mut Vec<a3955::structures::SoundModes>,
) {
...
fn set_noise_canceling_mode_dependants(
    ...
    match (current.noise_canceling_mode, to.noise_canceling_mode) {
        (
            a3955::structures::NoiseCancelingMode::Adaptive,
            a3955::structures::NoiseCancelingMode::Manual,
        ) => actions.swap(1, 2),
        (a3955::structures::NoiseCancelingMode::Adaptive, _) => (),

        (
            a3955::structures::NoiseCancelingMode::Manual,
            a3955::structures::NoiseCancelingMode::Adaptive,
        ) => actions.rotate_left(1),
        (a3955::structures::NoiseCancelingMode::Manual, _) => actions.swap(0, 1),

        (
            a3955::structures::NoiseCancelingMode::MultiScene,
            a3955::structures::NoiseCancelingMode::Manual,
        ) => actions.rotate_right(1),
        (a3955::structures::NoiseCancelingMode::MultiScene, _) => actions.swap(0, 2),
    }
    actions
        .into_iter()
...
fn set_adaptive_noise_canceling(
            ...
            != to.noise_canceling_adaptive_sensitivity_level
    {
        ...
        if current.noise_canceling_mode != a3955::structures::NoiseCancelingMode::Adaptive {
            current.noise_canceling_mode = a3955::structures::NoiseCancelingMode::Adaptive;
            sequence.push(*current);
        }
...
fn set_manual_noise_canceling(
    ...
    if current.manual_noise_canceling != to.manual_noise_canceling {
        ...
        if current.noise_canceling_mode != a3955::structures::NoiseCancelingMode::Manual {
            current.noise_canceling_mode = a3955::structures::NoiseCancelingMode::Manual;
            sequence.push(*current);
        }
...
fn set_multi_scene_anc(
    ...
    if current.multi_scene_anc != to.multi_scene_anc {
        ...
        if current.noise_canceling_mode != a3955::structures::NoiseCancelingMode::MultiScene {
            current.noise_canceling_mode = a3955::structures::NoiseCancelingMode::MultiScene;
            sequence.push(*current);
        }
...
mod tests {
    ...
    fn assert_valid_change(from: a3955::structures::SoundModes, to: a3955::structures::SoundModes) {
    ...
    fn average_case() {
        ...
        runner
            .run(
                &(
                    a3955::structures::SoundModes::arbitrary(),
                    a3955::structures::SoundModes::arbitrary(),
                ),
                |(from, to)| {
