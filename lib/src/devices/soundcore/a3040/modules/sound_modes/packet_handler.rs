...
impl SoundModesPacketHandler {
    pub const COMMAND: packet::Command = a3040::packets::SoundModesUpdate::COMMAND;
}

#[async_trait]
impl<T> PacketHandler<T> for SoundModesPacketHandler
where
    T: Has<a3040::structures::SoundModes> + Send + Sync,
{
    async fn handle_packet(
        ...
        let packet: a3040::packets::SoundModesUpdate = packet.try_to_packet()?;
