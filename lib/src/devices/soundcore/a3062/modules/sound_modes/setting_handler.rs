...
where
    T: Has<a3062::structures::SoundModes> + Send,
{
    ...
    async fn set(
        ...
        match sound_mode_setting {
            ...
            SoundModeSetting::ManualNoiseCanceling => {
                sound_modes.custom_noise_canceling = a3062::structures::CustomNoiseCanceling::new(
                    value.try_as_i32()?.clamp(u8::MIN as i32, u8::MAX as i32) as u8,
                );
            }
            SoundModeSetting::ManualTransparency => {
                sound_modes.custom_transparency = a3062::structures::CustomTransparency::new(
                    value.try_as_i32()?.clamp(u8::MIN as i32, u8::MAX as i32) as u8,
                );
            }
