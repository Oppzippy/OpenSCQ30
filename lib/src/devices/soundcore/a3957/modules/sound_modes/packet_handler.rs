...
impl SoundModesPacketHandler {
    pub const COMMAND: packet::Command = a3957::packets::inbound::A3957SoundModes::COMMAND;
}

#[async_trait]
impl<T> PacketHandler<T> for SoundModesPacketHandler
where
    T: Has<a3957::structures::SoundModes> + Send + Sync,
{
    async fn handle_packet(
        ...
        let packet: a3957::packets::inbound::A3957SoundModes = packet.try_to_packet()?;
