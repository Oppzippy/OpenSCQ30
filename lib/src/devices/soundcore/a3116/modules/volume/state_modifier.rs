...
pub struct VolumeStateModifier<ConnectionType: RfcommConnection> {
    packet_io: Arc<PacketIOController<ConnectionType>>,
}

impl<ConnectionType: RfcommConnection> VolumeStateModifier<ConnectionType> {
...
#[async_trait]
impl<ConnectionType, T> StateModifier<T> for VolumeStateModifier<ConnectionType>
where
