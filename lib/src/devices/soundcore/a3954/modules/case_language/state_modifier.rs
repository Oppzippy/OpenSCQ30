...
pub struct CaseLanguageStateModifier {
    packet_io: Arc<PacketIOController>,
}

impl CaseLanguageStateModifier {
...
#[async_trait]
impl<T> StateModifier<T> for CaseLanguageStateModifier
where
    T: Has<a3954::structures::CaseLanguage> + Clone + Send + Sync,
{
    async fn move_to_state(
        ...
        self.packet_io
            .send_with_response(&a3954::packets::outbound::set_case_language(target))
            .await?;
