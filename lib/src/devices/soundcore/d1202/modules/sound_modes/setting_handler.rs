...
where
    T: Has<d1202::structures::SoundModes> + Send,
{
    ...
    fn get(&self, state: &T, setting_id: &SettingId) -> Option<Setting> {
        ...
        Some(match sound_mode_setting {
            ...
            SoundModeSetting::RealTimeAdaptiveNoiseCanceling => Setting::Toggle {
                value: sound_modes.real_time_adaptive_anc,
            },
        })
    }
    ...
    async fn set(
        ...
        match sound_mode_setting {
            ...
            SoundModeSetting::RealTimeAdaptiveNoiseCanceling => {
                sound_modes.real_time_adaptive_anc = value.try_as_bool()?;
            }
            SoundModeSetting::NoiseCancelingMode => {
