...
soundcore_device!(
    A3933State,
    async |packet_io| {
        fetch_state_from_state_update_packet::<A3933State, A3933StateUpdatePacket>(packet_io).await
    },
    async |builder| {
        ...
        builder.reset_button_configuration::<A3933StateUpdatePacket>(RequestState.to_packet());
        builder.touch_tone();
        builder.gaming_mode();
