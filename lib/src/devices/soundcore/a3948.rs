...
soundcore_device!(
    A3948State,
    async |packet_io| {
        fetch_state_from_state_update_packet::<A3948State, A3948StateUpdatePacket>(packet_io).await
    },
    async |builder| {
        ...
        builder.reset_button_configuration::<A3948StateUpdatePacket>(RequestState.to_packet());
