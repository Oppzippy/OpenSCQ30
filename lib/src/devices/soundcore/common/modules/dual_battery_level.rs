...
use crate::{
    ...
    devices::soundcore::common::structures::DualBatteryLevel,
    macros::enum_subset,
};
...
pub struct DualBatteryLevelConfiguration {
...
where
    T: Has<DualBatteryLevel> + Clone + Send + Sync,
{
    pub fn add_dual_battery_level(&mut self, configuration: DualBatteryLevelConfiguration) {
